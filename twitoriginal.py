...
class tweetscrap:
    ...
    def __init__(self):
            ...
            self.number_tweets=100
            self.search_word=""#all word in search #scrape the tweet if all the words included,
            self.phrase=""#'accident in india'(comma seprated) #scrape the tweet if and only the phrase is present
            self.hashtags=""# '#accidents,#india'(#wordcomma seprated)
            self.keywords="surgery,medicine"#'india,cricket'(comma seprated)#any of the word in keywords #work well with single keyword #scrap the tweet if any of the word is included in the tweer
